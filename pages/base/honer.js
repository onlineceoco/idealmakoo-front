...
export default function Honer() {
    return (
        <>
            ...
            displatChart="none"
            img1Slider="/images/24.jpg" 
            img2Slider="/images/18.jpg" 
            img3Slider="/images/16.jpg" 
            title1Banner="گواهی و افتخارات "
            img2Banner="/images/export3.png"
            title2Banner=" مقام اول  همایش توسعه "
            subtitle2Banner=" منطقه آزاد ماکو"
            title3Banner="واحد نمونه استانی"
            img3Banner='/images/estandard.png'
            subtitle3Banner="اداره کل استاندارداستان آذربایجانغربی"
            title4Banner="مقام اول همایش توسعه صادرات"
            img4Banner='/images/export.png'
            subtitle4Banner="منطقه آزاد ماکو"
            title5Banner=" رتبه برتر صادرات سال  "
            img5Banner='/images/export2.png'
            subtitle5Banner="1398"
