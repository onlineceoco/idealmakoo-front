...
export const menuItems = [
  ...
  },
  {
    name: "تحقیق و توسعه",
    subMenus: [
      { name: "خبرنامه دندان", to: "/r&d/news" },
      { name: "مقالات ایده آل ماکو", to: "/r&d/articles" },
      { name: "منابع علمی", to: "/r&d/scientificResources" },
  ...
  },
  {
    name: "پشتیبانی",
    subMenus: [
      { name: "مشاوره محصول", to: "/Support/product-advice" },
