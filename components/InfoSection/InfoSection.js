...
const InfoSection = ({lightBg, id, topLine, headLine, description, buttonLable,img,alt,imgStart, lightText, darkText, dark, dark2, primary,imgDisplay,videoDisplay,respDisplay }) => {
    return (
        <>
